...
import type { Band, CellType, Rat } from "./common_pb.js";
...
export const file_station_cells: GenFile = /*@__PURE__*/
  fileDesc("", [file_common]);
...
export type CellWithoutDetails = Message<"openbts.stations.CellWithoutDetails"> & {
  ...
  /**
   * @generated from field: openbts.CellType type = 10;
   */
  type: CellType;
};
