...
export const file_common: GenFile = /*@__PURE__*/
  fileDesc("");
...
/**
 * @generated from enum openbts.CellType
 */
export enum CellType {
  /**
   * @generated from enum value: CELL_TYPE_UNKNOWN = 0;
   */
  CELL_TYPE_UNKNOWN = 0,

  /**
   * @generated from enum value: MACROCELL = 1;
   */
  MACROCELL = 1,

  /**
   * @generated from enum value: MICROCELL = 2;
   */
  MICROCELL = 2,

  /**
   * @generated from enum value: PICOCELL = 3;
   */
  PICOCELL = 3,

  /**
   * @generated from enum value: FEMTOCELL = 4;
   */
  FEMTOCELL = 4,

  /**
   * @generated from enum value: SMALLCELL = 5;
   */
  SMALLCELL = 5,
}

/**
 * Describes the enum openbts.CellType.
 */
