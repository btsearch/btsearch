import { formatNsgTimestamp } from "@/lib/nsg-parser";
import type { NsgCell, NsgJsonValue, NsgLog } from "@/lib/nsg-parser/model";
...
export function createCellsCsv(log: NsgLog, cells: NsgCell[] = log.cells): string {
