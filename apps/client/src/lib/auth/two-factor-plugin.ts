...
import { type TwoFactorPluginOptions, twoFactorPlugin as coreTwoFactorPlugin } from "@better-auth-ui/core/plugins/two-factor";
...
export const twoFactorPlugin = createAuthPlugin(coreTwoFactorPlugin.id, (options: TwoFactorPluginOptions = {}) => ({
