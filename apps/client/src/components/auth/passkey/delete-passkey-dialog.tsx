    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>{passkeyLocalization.deletePasskeyWarning}</AlertDialogDescription>
        </AlertDialogHeader>
        ...
        <AlertDialogFooter>
          ...
          <Button type="button" variant="destructive" disabled={isDeleting} onClick={() => deletePasskey({ id: passkey.id })}>
            {isDeleting && <Spinner />}
