      ...
      <DialogContent>
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <Field>
            ...
            <Input id="passkey-name" name="name" autoFocus placeholder={localization.settings.optional} disabled={isAdding} />

            <FieldError />
          </Field>

          <DialogFooter>
            <DialogClose className={buttonVariants({ variant: "outline" })} disabled={isAdding} type="button">
