...
function diffFields(
  oldValues: PlainObject | null,
  newValues: PlainObject | null,
...
function flattenCell(value: unknown): PlainObject | null {
...
function cellSnapshot(flat: PlainObject, lookups: StationHistoryLookups): Record<string, StationHistoryValue> {
...
function cellLabel(flat: PlainObject, lookups: StationHistoryLookups): string | undefined {
...
function cellIdentifier(flat: PlainObject): string | undefined {
  const rat = typeof flat.rat === "string" ? flat.rat : null;
...
function extractCellList(values: unknown): PlainObject[] {
